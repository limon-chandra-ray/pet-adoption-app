...
const PetList = () => {
  ...
  const fetchPets = async () => {
    try {
      setIsLoading(true);
      const response = await axios.get(`${BaseUrl}pet-listing`);
  ...
  const savePet = async () => {
    try {
      if (currentPet._id) {
        await axios.put(`${BaseUrl}pet-listing/${currentPet._id}`, currentPet);
        ...
        await axios.post(`${BaseUrl}pet-listing`, currentPet);
  ...
  const deletePet = async (id) => {
    try {
      await axios.delete(`${BaseUrl}pet-listing/${id}`);
